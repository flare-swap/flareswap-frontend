export const swapRouterABI: any = [
  {
    type: "constructor",
  ...
  { type: "function", stateMutability: "view", outputs: [{ type: "address", name: "", internalType: "address" }], name: "WETH9", inputs: [] },
  {
    type: "function",
